# Kimi Code 操作步骤：AI 纪念合照 Android App

这份文档给 Kimi Code 使用。目标是用分阶段、可验证的方式完成一个 Android-first 的 AI 纪念合照 App，而不是一次性生成整个项目。
...
- 用户上传自己和逝去亲人的照片
- 云端用 `gpt-image-2` 生成 AI 合照
- 免费展示低清水印预览
- 用户通过 Google Play Billing 付费
- 付费后下载高清照片
- 可选生成一段纪念相册式 MP4 微动视频

第一版重点是私密纪念，不做娱乐化 deepfake。
